      ...
      {isOpen && (
        ...
        >
          <nav className='flex items-center flex-col justify-center mb-4'>
            <CustomLink href='/' title='Home' className='m-2' invert onClick={handleclick}/>
            <CustomLink href='/about' title='About' className='m-2' invert onClick={handleclick}/>
            <CustomLink href='/projects' title='Projects' className='m-2' invert onClick={handleclick}/>
          </nav>
